...
namespace TiendaMusica.Data.InsightDB
{
    public class TiendaMusicaDB : ITiendaMusicaRepository
    {
        ...
        {
            db = new SqlConnection(ConfigurationManager.ConnectionStrings[connectionStringName].ConnectionString);
        ...
        public void ProdAdHoc(string query, object parameters)
        {
            db.ExecuteSql(query, parameters);
        }


        //public void ConsultaAdHocSingle<TResult>(string query, object parameters)
        //{
        //    return (TResult)db.QuerySql(query, parameters);
        //}
    }
}
